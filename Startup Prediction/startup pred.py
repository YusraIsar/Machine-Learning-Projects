...
startup = pd.read_csv(r"C:\Users\HP\Desktop\50_Startups .csv")
startup = pd.get_dummies(startup, columns=['State'], drop_first=True)  # as state is a categorical variable and the system dont read that
